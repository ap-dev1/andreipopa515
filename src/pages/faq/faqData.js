export const faqData = [
...

    {
        ...
        answer: ["Yes. If we are unable to generate action at will, we are at the very least able to veto what the brain started. I explain how to approach the study of free will and related phenomena in Popa (2019a)."]
    },
...

    {
        ...
        answer: ["Good one. Replace the term with its definition and read the text again. If it doesn't make sense, the term was used incorectly. Here's an example from McDowell (2010, p. 358; emphasis added):",

            // "https://naturaldrift.files.wordpress.com/2009/12/skinner-1981-selection-by-consequences.pdf",
            "<blockquote>... <b>evolution</b> engineered a copy of <b>itself</b> in the nervous systems of biological organisms to regulate their behavior ... (McDowell et al., 2008, p. 400).</blockquote>",


            "When we replace the term with its definition there is no one left to engineer or regulate. The paragraph no longer makes sense:",
            "<blockquote>... <b>Change in the genetic composition of a population</b> engineered a copy of <b>change in the genetic composition of a population</b> in the nervous systems of biological organisms to regulate their behavior ...</blockquote>"
        ]
    },
